...
struct ErrorRecoveryView: View {
    ...
    private func clearAppCache() {
        // Clear user defaults for demo mode and other settings
        UserDefaults.standard.removeObject(forKey: "isDemoMode")
        UserDefaults.standard.removeObject(forKey: "hasSeededDemoData")
    ...
    private func openAppStore() {
        ...
        if let url = URL(string: "https://apps.apple.com/app/express-coach") {
...
#Preview("Error Recovery") {
    ErrorRecoveryView(
        error: NSError(
            ...
            code: 1001,
            userInfo: [
                NSLocalizedDescriptionKey: "Failed to create model container",
                NSLocalizedFailureReasonErrorKey: "The persistent store could not be initialized"
            ]
        ),
        retryAction: {
            print("Retry tapped")
